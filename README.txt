...
Create centralized control over who can see & edit which media items on CC.
...
* be able to edit and delete media that she has uploaded.

The filters happen at early priorities so that other plugins can change the
behavior at later priorities.

== Changelog ==

= 1.0 =
* First version. Basic functionality is in place.